...
<?php
$breadcrumbs = array( 'base' => '活动管理', 'list' => array( array('url'=>U('Activity/activity_list', array('sguid'=>$subject_info['guid'])), 'v'=>'活动列表'), array('url'=>U('Activity/activity_view', array('guid'=>$activity_info['guid'])), 'v'=>'活动详情'), array('url'=>'', 'v'=>'编辑活动') ) ); ?>
        ...
        <div class="pdlf10 mb40 ml12">
          ...
          <div class="row mt10">
              ...
              <div class="pull-left width190">
                <div class="input-group date form_datetime">
                  <div>
                  	<input class="form-control" size="16" type="text" value="<?php echo date('Y-m-d H:i',$activity_info['start_time']);?>" name="startTime" id="startTime" readonly></div>
              ...
              <div class="pull-left width190">
                <div class="input-group date form_datetime">
                 <div>
                 	<input class="form-control" size="16" type="text" value="<?php echo date('Y-m-d H:i',$activity_info['end_time']);?>" name="endTime" id="endTime" readonly></div>
                  <span class="input-group-addon radius0"><span class="glyphicon glyphicon-th"></span></span>
                </div>
          ...
          <div class="row">
            ...
            <div class="pull-left width675">
                <textarea id="ym_editor" name="content">
          ...
          <div class="row">
            ...
            <div class="pull-left">
              <label class="radio-inline">
                <input type="radio" name="status" id="status1" value="1" <?php echo ($activity_info['status']=='1')?'checked':''; ?>> 是
              </label>
              <label class="radio-inline">
                <input type="radio" name="status" id="status0" value="0" <?php echo ($activity_info['status']=='0')?'checked':''; ?>> 否
              </label>
            </div>
          </div>
