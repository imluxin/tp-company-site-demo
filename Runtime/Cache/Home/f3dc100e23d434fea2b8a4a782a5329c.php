...
<div class="rightmain">
    ...
    <div class="pull-right">
        ...
        <div class="row mt10">
            ...
            <div class="pull-left width420"><img width="23px" src="<?php echo PUBLIC_URL;?>/home/images/activity2.png" alt="投票">投票</div>
        </div>
        <div class="row mt10">
        ...
        <div class="row mt10">
            <div class="pull-left width80">投票标题：</div>
            <div class="pull-left width675"><?php echo $activity_info['name']?></div>
        </div>
        <div class="row mt10">
            <div class="pull-left width80">投票描述：</div>
            <div class="pull-left width675"><?php echo $vote_info['content']?></div>
        </div>
        <div class="row mt10">
            <div class="pull-left width80"><p style="text-indent: 2em;">类型：</p></div>
            <div class="pull-left width420"><?php echo ($vote_info['is_multiple']=='1')?'多选':'单选'; ?></div>
        </div>

        <?php if($vote_info['is_multiple']=='1'): ?>
        <div class="row">
            <div class="pull-left width92 ml-12">最多选几项：</div>
            <div class="pull-left width420"><?php echo empty($vote_info['multiple_num'])?'不限':$vote_info['multiple_num'] ?></div>
        </div>
        <?php endif; ?>

        <div class="row mt10">
            <div class="pull-left width80">参与情况：</div>
            <div class="pull-left width675"><span>共</span><span class="ml5"><name0><?php echo $vote_num?></name0></span><span class="ml5">人参与投票；</span><span class="ml5">总票数</span><span class="ml5"><name0><?php echo $ava_vote_num?></name0></span><span class="ml5">票</span></div>
        </div>
        <div class="row mt10">
            <div class="pull-left width80">投票结果：</div>
            <div class="pull-left width675">
                <table class="table table-bordered">
                    <thead>
                    <tr class="active">
                        <td class="wh380"><name0>选项名称</name0></td>
                        <td class="wh60"><name0>投票数</name0></td>
                        <td class="wh60"><name0>百分百</name0></td>
                        <td class="wh175"></td>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr>
                        <td class="wh380">
                            <?php echo $o['content']?><br/>
                            <?php if (!empty($o['pic_url'])) :?>
                                <a href="<?php echo get_image_path($o['pic_url']); ?>" target="_blank">
                                <img data-original="<?php echo get_image_path($o['pic_url'])?>" style="height: 100px;" class="lazy">
                                </a>
                            <?php endif; ?>
                        </td>
                        <td class="wh60"><?php echo $option_static[$o['guid']]['sum']?></td>
                        <td class="wh60"><?php echo $option_static[$o['guid']]['percent']?>%</td>
                        <td class="wh175">
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $option_static[$o['guid']]['percent']?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $option_static[$o['guid']]['percent']?>%;">
                                </div>
                            </div>
                        </td>
                    </tr>
		        ...
		        <?php if($activity_info['status']==1):?>
			        <div class="row">
			            <div class="pull-right btn-group">
				            <button type="button" class="btn mybtn" onclick="javascript:history.go(0);">刷新</button>
			            </div>
			        </div>
				<?php endif; ?>
            </div>
