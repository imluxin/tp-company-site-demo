...
<div class="rightmain">
    ...
    <div class="btn-group width798 pdlf10">
        <div class="pull-left"><h4>报名详情</h4></div>
    ...
    <div class="pull-right">
        ...
        <?php if($activity_info['status'] != 0):?>
        <div class="row mt10">
            <div class="pull-left width80">报名情况：</div>
            <div class="pull-left width675"><span>共</span><span class="ml5"><name0><?php echo $user_count; ?></name0></span><span class="ml5">人报名</span></div>
        </div>
        <?php endif; ?>

        <?php if ($activity_info['is_public'] == '1'): ?>
            <div class="row mt10">
                <div class="pull-left width80">报名地址：</div>
                <?php $signup_address = U('Mobile/activity/view', array('aid' => $activity_info['guid']), true, true); ?>
                <div class="pull-left width675">
                    <a target="_blank" href="<?php echo $signup_address; ?>" title="报名网址" class="word-wrap"><?php echo $signup_address; ?></a>
                    <a href="javascript:void(0);" title="复制地址" class="copy-button pull-right" data-clipboard-text="<?php echo $signup_address?>">复制地址</a>
                </div>
            </div>
            <div class="row mt10">
                <div class="pull-left width92 ml-12">报名二维码：</div>
                <div class="pull-left">
        ...
        <div class="row mt10">
            ...
            <div class="pull-left width420"><img width="23px" src="<?php echo PUBLIC_URL;?>/home/images/activity<?php echo $activity_info['type']; ?>.png" alt="报名">报名</div>
        </div>
        <div class="row mt10">
        ...
        <div class="row mt10">
            <div class="pull-left width80">报名时间：</div>
            <div class="pull-left width420"><span><?php echo date('Y-m-d H:i',$signup_info['start']);?></span><span class="ml12">至</span><span class="ml12"><?php echo date('Y-m-d H:i',$signup_info['end']);?></span></div>
        </div>
        <div class="row mt10">
            <div class="pull-left width80">活动地点：</div>
            <div class="pull-left width675">
                <?php echo $address = $signup_info['areaid_1_name'].' '.$signup_info['areaid_2_name'].' '.$signup_info['address']; ?>
                <a href="javascript:void(0);" onclick="show_map('<?php echo $address?>');">查看地图位置</a>
            </div>
        </div>
        <div class="row mt10">
            <div class="pull-left width80">活动海报:</div>
            <div class="pull-left width675"><img src="<?php echo get_image_path($signup_info['poster'], 'upload-postersimg.png')?>" class="upload-posters"></div>
        </div>
        <div class="row mt10">
        ...
        <div class="row mt10">
            <div class="pull-left width80">参与人数：</div>
            <div class="pull-left width675"><?php echo ($signup_info['num_person'] == 0 || empty($signup_info['num_person'])) ? '无限制' : $signup_info['num_person']; ?></div>
        </div>
        <div class="row mt10">
        ...
        <div class="row mt10">
            <div class="pull-left width80">活动描述：</div>
            <div class="pull-left width675"><?php echo htmlspecialchars_decode($signup_info['content'])?></div>
        </div>

        <div class="row mt10">
            <div class="pull-left width80">活动流程：</div>
            <div class="pull-left width675">
                <?php foreach($flow as $f):?>
                    <div class="mb10">
                        <?php echo $f['title']?><br><?php echo date('Y-m-d H:i', $f['start_time']); ?> 至 <?php echo date('Y-m-d H:i', $f['end_time']); ?>
                        <br><?php echo $f['content']; ?>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="row mt10">
            <div class="pull-left width80">承办机构：</div>
            <div class="pull-left width675">
                <?php foreach($undertaker as $u): ?>
                <div class="mb10"><?php echo C('ACTIVITY_UNDERTAKER')[$u['type']].': '.$u['name']; ?></div>
                <?php endforeach; ?>
            </div>
        </div>
