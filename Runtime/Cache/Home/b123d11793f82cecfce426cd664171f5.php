...
<div class="ymnaw">
    <ul class="nav nav-tabs ymbtn" role="tablist">
        <li role="presentation" class="<?php echo (ACTION_NAME == 'activity_view') ? 'active' : ''; ?>"><a href="<?php echo U('activity/activity_view', array('guid' => $activity_info['guid']))?>">问卷详情</a></li>
        <li role="presentation" class="<?php echo (ACTION_NAME == 'question_collect') ? 'active' : ''; ?>"><a href="<?php echo U('activity/question_collect', array('guid' => $activity_info['guid']))?>">问卷收集</a></li>
        <!--  <li role="presentation" class="<?php echo (ACTION_NAME == '') ? 'active' : ''; ?>"><a href="javascript:void(0);">问卷分析</a></li> -->
    </ul>
</div>
...
<div class="rightmain">
    ...
    <div class="btn-group width798 pdlf10">
        <div class="pull-left"><h4>问卷详情</h4></div>
    ...
    <div class="pdlf10 ml12 mb40">
        ...
        <div class="row mb10">
            <div class="pull-right">
                <div class="pull-right">
    <?php if(($activity_info["status"]) == "0"): ?><button type="button" class="btn mybtn" onclick="location.href='<?php echo U('Activity/activity_edit', array('guid'=>$activity_info['guid']))?>'">编辑</button>
        <button type="button" class="ym_del btn mybtn" url="<?php echo U('Activity/activity_del', array('guid'=>$activity_info['guid']))?>">删除</button>
    <?php else: ?>
        <button type="button" class="ym_del btn mybtn" url="<?php echo U('Activity/close', array('guid'=>$activity_info['guid']))?>">关闭活动</button><?php endif; ?>
</div>
        ...
        <div class="row mt10">
            ...
            <div class="pull-left width420"><img width="23px" src="/Public/home/images/activity<?php echo ($activity_info["type"]); ?>.png" alt="问卷">问卷</div>
        </div>
        <div class="row mt10">
        ...
        <div class="row mt10">
            ...
            <div class="pull-left width675"><?php if(($question_info["is_public"]) == "1"): ?>是<?php else: ?>否<?php endif; ?></div>
        </div>
        <div class="row mt10">
            <div class="pull-left width80">问卷标题：</div>
            <div class="pull-left width675"><?php echo ($activity_info["name"]); ?></div>
        </div>
        <div class="row mt10">
            <div class="pull-left width80">问卷描述：</div>
            <div class="pull-left width675"><?php echo ($question_info["description"]); ?></div>
        </div>
        <div class="row mt10">
            <div class="pull-left width80">结束提示：</div>
            <div class="pull-left width675"><?php echo ($question_info["conclusion"]); ?></div>
        </div>
    </div>
