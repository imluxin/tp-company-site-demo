        ...
        <table class="table">
            <tbody>
              ...
              <tr class="base-tr1">
                ...
                <td class="wh570 status-text"><?php if(($info["reg_url"]) == "1"): ?>开启<?php else: ?>关闭<?php endif; ?></td>
                <td class="wh78">
                    <a href="javascript:void(0);" data-state="<?php if(($info["reg_url"]) == "1"): ?>1<?php else: ?>0<?php endif; ?>" class="js-invite" width="500" height="330"><?php if(($info["reg_url"]) == "1"): ?>关闭<?php else: ?>开启<?php endif; ?></a>
                </td>
              </tr>
              <tr>
                <td class="wh140">注册审核</td>
                <td class="wh570 status-text"><?php if(($info["reg_examine"]) == "1"): ?>开启<?php else: ?>关闭<?php endif; ?></td>
                <td class="wh78">
                    <a href="javascript:void(0);" data-state="<?php if(($info["reg_examine"]) == "1"): ?>1<?php else: ?>0<?php endif; ?>" class="js-examine" width="500" height="330"><?php if(($info["reg_examine"]) == "1"): ?>关闭<?php else: ?>开启<?php endif; ?></a>
                </td>
              </tr>
              <tr>
