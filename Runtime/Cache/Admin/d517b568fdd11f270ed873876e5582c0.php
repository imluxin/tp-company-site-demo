...
<html>
    ...
    <a href="<?php echo U('App/index');?>" class="list-group-item"><i class="fa fa-download"></i>下载申请</a>
				...
				<div class="col-sm-9 col-md-10">
					<script type="text/javascript" src="/Public/admin/js/levelAdd.js"></script>
<script type="text/javascript">
	var YM = {
		'saveLevel' : "<?php echo U('save_level');?>",
		'checkName': "<?php echo U('check_name');?>",
...
<form class="form-horizontal" role="form" id="regorg">
	<div class="form-group">
		...
		<div class="col-sm-6">
			<input type="text" id="name" name="name" class="form-control"  value="<?php echo ($levelData["name"]); ?>" placeholder="输入等级名称">
			<input type="hidden"  name="guid"  value="<?php echo ($_GET['guid']); ?>">
		</div>
		<div class="col-sm-4 error-wrap"></div>
	</div>
	<div class="form-group">
		<label for="sort" class="col-sm-2 control-label">等级排序</label>
		<div class="col-sm-6">
			<input type="text" id="sort" name="sort" class="form-control"  value="<?php echo ($levelData["sort"]); ?>" placeholder="输入等级标识">
		</div>
		<div class="col-sm-4 error-wrap"></div>
	</div>
	<div class="form-group">
