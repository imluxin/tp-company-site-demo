...
<h2 class="page-header">
    <a href="<?php echo U('Task/flow_edit');?>" type="button" class="pull-right btn btn-danger ml10"><span class="glyphicon glyphicon-plus"></span> 新增任务流</a>
    <a href="<?php echo U('Task/index');?>" type="button" class="pull-right btn btn-success"><span class="fa fa-tasks"></span> 任务管理</a>
            任务流管理
</h2>
<form id="form" method="post" action="<?php echo U('Upload/index')?>">
    <table border="1" cellspacing="0" cellpadding="10" class="table table-bordered">
        ...
        <tbody>
        <?php if(!empty($flow_list)): if(is_array($flow_list)): $i = 0; $__LIST__ = $flow_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($vo['id']); ?></td>
                    <td><?php echo ($vo['name']); ?></td>
                    <td><a href="<?php echo U('flow_edit',array('guid'=>$vo['guid']));?>"><i class="glyphicon glyphicon-search"></i></a></td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            <?php else: ?>
            <tr>
                <td colspan="4">记录没有找到！</td>
            </tr><?php endif; ?>
        </tbody>
    </table>
    <?php echo ($page); ?>
