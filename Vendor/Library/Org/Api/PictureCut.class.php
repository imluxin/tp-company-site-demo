...
// var_dump($this->imageName);
		if($this->imageNameRandom == "true"){
		    ...
		    $this->currentFileName = $this->imageName.".".$this->fileType;
		} else {
	...
	public function upload(){
		...
		try {								
// 		    var_dump($this->fileStream, $this->currentFile,$_SERVER["DOCUMENT_ROOT"], $this->folderOnServer, $this->currentFileName);
...
//                         'savePath' => '/org/'.$this->imageName.'/logo/',
//                         'subName'  => '',
//                         'saveName' => $this->imageName,
//                         'saveExt'  => C('SAVE_EXT'),
//                         'replace'  => true
//                 );
