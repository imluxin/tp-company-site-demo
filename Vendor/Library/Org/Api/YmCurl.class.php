...
class YmCurl {
     ...
     * @author andy
     **/
    public function get( $url, $header = 0, $cookie='' )
    {
        // 初始化一个cURL会话
        $curl = curl_init($url);
        // 不显示header信息
//        curl_setopt($curl, CURLOPT_HEADER, 0);
     ...
     * @author andy
     **/
    public function post( $url, $params, $header = 0, $cookie='' )
    {
        $curl = curl_init($url);
//        curl_setopt(  $curl, CURLOPT_HEADER, 0);
        curl_setopt ( $curl, CURLOPT_HTTPHEADER, $header ); // 设置HTTP头
     ...
     * @author andy
     **/
    public function put( $url, $params, $header = 0, $cookie='' )
    {
        $curl = curl_init($url);
//        curl_setopt($curl, CURLOPT_HEADER, 0);
        curl_setopt ( $curl, CURLOPT_HTTPHEADER, $header ); // 设置HTTP头
     ...
     * @author andy
     **/
    public function delete( $url, $params = array(), $header = 0, $cookie='' )
    {
        $curl = curl_init($url);
//        curl_setopt($curl, CURLOPT_HEADER, 0);
        curl_setopt ( $curl, CURLOPT_HTTPHEADER, $header ); // 设置HTTP头
