...
class Page{
    ...
    private $config  = array(
        ...
        'first'  => '首页',
        'last'   => '尾页',//'...%TOTAL_PAGE%',
        'theme'  => '<ul class="pagination pagination-sm">%FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END%</ul>',
    );
    ...
    public function show() {
        ...
        if($this->totalPages > $this->rollPage && ($this->nowPage + $now_cool_page) < $this->totalPages){
            $the_end = '<li><a class="end" href="' . $this->url($this->totalPages) . '">尾页</a></li>';//' . $this->config['last'] . '
        }
